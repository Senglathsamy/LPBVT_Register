...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="font-weight: bold; font-size: 100%">
            ...
            <li class="active">ເພີ່ມຂໍ້ມູນອາຈານສອນ</li>
        </ol>
    </section>
                ...
                <div class="box box-info">
                    ...
                    <div class="form-group">
                        <div class="{{ $errors->has('bprovince') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                {!! Form::select('bprovince', App\Province::where('country_code','LA')->pluck('province_name_lo', 'id')->toArray(), null, ['class' => 'select2 form-control', 'placeholder' => '--ແຂວງເກີດ--', 'required']) !!}
                        ...
                        <div class="{{ $errors->has('bdistrict') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                {!! Form::select('bdistrict', App\District::where('prov_id', old('bprovince'))->pluck('district_name_lo','id')->toArray(), null, ['class' => 'select2 form-control', 'placeholder' => '--ເມືອງເກີດ--', 'required']) !!}
                    ...
                    <div class="form-group">
                        <div class="form-group{{ $errors->has('te_status') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                {!! Form::select('te_status', App\TeacherStatus::pluck('status', 'id'), 1, ['class' => 'select2 form-control', 'placeholder' => '--ສະຖານະພາບ--', 'required']) !!}
