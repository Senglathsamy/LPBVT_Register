...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="font-size: 100%; font-weight: bold;">
            ...
            <li class="active">ເພີ່ມຂໍ້ມູນພາກວິຊາ</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        {!! Form::open(['url'=> 'dept', 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <a href="{{ url('/dept') }}" class="btn bg-orange"
                                               style="font-weight: bold;"><span
                                            class="glyphicon glyphicon-remove"></span> ຍົກເລີກ</a>
                                &nbsp;&nbsp;<button type="submit" class="btn bg-blue"
                                                    style="font-weight: bold;">ເພີ່ມຂໍ້ມູນພາກວິຊາ <span
