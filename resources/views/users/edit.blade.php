...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="font-size: 100%; font-weight: bold;">
            ...
            <li class="active">ແກ້ໄຂຂໍ້ມູນຜູ້ໃຊ້ລະບົບ</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        {!! Form::model($user, array('url' => 'users/' . $user->id, 'method' => 'PATCH', 'class' => 'form-horizontal')) !!}
                        ...
                        <div class="form-group{{ $errors->has('roles') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                {!! Form::select('roles[]', $roles,$userRole, ['class' => 'select2 form-control', 'placeholder' => 'ເລືອກສິດທິໃຫ້ກັບຜູ້ໃຊ້', 'required', 'multiple' => 'multiple']) !!}
                                @if ($errors->has('roles'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('te_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-5">
                                {!! Form::select('te_id', [null=>'--- ບໍ່ຜູກອາຈານໃສ່ຜູ້ໃຊ້ ---'] + App\Teacher::select(DB::raw("CONCAT(te_init, ' ', te_firstname,' ', te_lastname) AS full_name, id"))->pluck('full_name', 'id')->toArray(), null, ['class' => 'select2 form-control']) !!}
                                @if ($errors->has('te_id'))
                                    <span class="help-block">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                &nbsp;&nbsp;<button type="submit" class="btn bg-green"
                                                    style="font-weight: bold;">ແກ້ໄຂຜູ້ໃຊ້ລະບົບ <span
