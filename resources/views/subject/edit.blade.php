...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="font-weight: bold; font-size: 100%;">
            ...
            <li class="active">ແກ້ໄຂຂໍ້ມູນລາຍວິຊາ</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <?= Form::model($subject, array('url' => 'subject/' . $subject->id, 'method' => 'PATCH', 'class' => 'form-horizontal')) ?>

                        <div class="form-group{{ $errors->has('sub_id') ? ' has-error' : '' }}">
                            {!! Form::label('sub_id', 'ລະຫັດວິຊາ:', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                                {!! Form::text('subid', $subject->sub_id, ['class' => 'form-control', 'placeholder' => 'ລະຫັດວິຊາ' , 'required', 'disabled']) !!}
                                {!! Form::hidden('sub_id', null, ['class' => 'form-control' , 'required']) !!}
                        ...
                        <div class="form-group{{ $errors->has('sub_credit') ? ' has-error' : '' }}">
                            {!! Form::label('sub_credit', 'ຈຳນວນໜ່ວຍກິດ:', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('sub_unit1') ? ' has-error' : '' }}">
                            {!! Form::label('sub_unit1', 'ຊົ່ວໂມງບັນຍາຍ:', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('sub_unit2') ? ' has-error' : '' }}">
                            {!! Form::label('sub_unit2', 'ຊົ່ວໂມງປະຕິບັດ:', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('sub_unit3') ? ' has-error' : '' }}">
                            {!! Form::label('sub_unit3', 'ຊົ່ວໂມງທົດລອງ:', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                &nbsp;&nbsp;<button type="submit" class="btn bg-green" style="font-weight: bold;">ແກ້ໄຂຂໍ້ມູນ <span class="glyphicon glyphicon-ok"></span> </button>
                            </div>
                        </div>
