...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="font-size: 100%; font-weight: bold;">
            ...
            <li class="active">ແກ້ໄຂຂໍ້ມູນລະບົບການຮຽນ</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <?= Form::model($degree, array('url' => 'degree/' . $degree->id, 'method' => 'PATCH', 'class' => 'form-horizontal')) ?>
                        ...
                        <div class="form-group{{ $errors->has('program') ? ' has-error' : '' }}">
                            {!! Form::label('program', 'ລະບົບ', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                                {!! Form::text('program', null, ['class' => 'form-control', 'placeholder' => 'ລະບົບການສຶກສາ' , 'required']) !!}
