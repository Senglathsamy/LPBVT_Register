...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="font-weight: bold; font-size: 100%;">
            ...
            <li><a href="{{ url('/upgrade') }}">ຂໍ້ມູນລົງທະບຽນອັບເກຣດ</a></li>
            <li><a href="{{ url('/check_upgrade/before_create') }}">ກວດສອບຂໍ້ມູນລົງທະບຽນອັບເກຣດ</a></li>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('ug_recieptno') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('ug_recieptno', null, ['class' => 'form-control', 'placeholder' => 'ກະລຸນາປ້ອນເລກໃບບິນ', 'required']) !!}
                        ...
                        <div class="form-group{{ $errors->has('ug_paiddate') ? ' has-error' : '' }} date">
                            ...
                            <div class="col-md-6">
                                {!! Form::text('ug_paiddate', null, ['class' => 'form-control', 'placeholder' => 'ກະລຸນາເລືອກວັນທີຊຳລະຄ່າລົງທະບຽນ' , 'required', 'id' => 'datepicker1' ]) !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <a href="{{ URL::previous() }}" class="btn bg-orange"
