...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb" style="font-size: 100%; font-weight: bold;">
            ...
            <li><a href="{{ url('/role') }}">ສິດທິຜູ້ເຂົ້າໃຊ້ລະບົບ</a></li>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'ຊື່ສິດທິ [Englist]' , 'required']) !!}
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-1">
                                ...
                                &nbsp;&nbsp;<button type="submit" class="btn bg-blue" style="font-weight: bold;">ເພີ່ມສິດທິຜູ້ເຂົ້າໃຊ້ <span class="glyphicon glyphicon-ok"></span> </button>
                            </div>
                        </div>
